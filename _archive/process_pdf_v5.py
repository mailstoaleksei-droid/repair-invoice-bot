...
С единым Telegram модулем (unified_telegram.py)
Цель: Максимальная автоматизация + чистый код
"""
...
def process_all_pdfs():
    ...
    print("\n╔══════════════════════════════════════════════════════════════╗")
    print("║      PDF PROCESSOR v5.0 - УНИФИЦИРОВАННАЯ ВЕРСИЯ            ║")
    print("║      Единый Telegram модуль + Паттерны извлечения           ║")
    print("╚══════════════════════════════════════════════════════════════╝\n")
