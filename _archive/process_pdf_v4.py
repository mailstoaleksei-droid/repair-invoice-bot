"""
PDF PROCESSOR v4.0 - ИНТЕГРИРОВАННАЯ ВЕРСИЯ
Объединяет детальные уведомления v3.0 с паттернами извлечения из ultimate
Цель: Максимальная автоматизация + детальная обратная связь
"""
...
def process_all_pdfs():
    ...
    print("\n╔══════════════════════════════════════════════════════════════╗")
    print("║      PDF PROCESSOR v4.0 - ИНТЕГРИРОВАННАЯ ВЕРСИЯ            ║")
    print("║      Детальные уведомления + Паттерны извлечения            ║")
    print("╚══════════════════════════════════════════════════════════════╝\n")
        ...
        try:
            ...
            if is_duplicate:
                ...
                if success:
                    ...
                    # Уведомление
                    if TELEGRAM_ENABLED and DETAILED_NOTIFICATIONS:
                        notifier.notify_duplicate(pdf_file, data['invoice'], original_date)
